...
body {
  color: #000;
   background: url(Calendar_0.jpg) no-repeat center center fixed; 
...
<div class="container">
  <section id="content">
    <form id="form1" name="form1" method="post" action = "./index.php">
      ...
      <div>
        <input type="text" placeholder="Email address" required="" id="email" name="id" />
      </div>
      <div>
  ...
  if(isset($_POST['submit']))
{
      if($flag==0){
        ...
        ?>
        <p style="color:red;">Incorrect email adresss/ password </p>
        <?php
      }
